...
[Layouts.kt](/lesson04/app/src/main/java/com/example/compose_sample/layout/Layouts.kt)
...
[Lists.kt](/lesson04/app/src/main/java/com/example/compose_sample/layout/Lists.kt)
...
[LayoutsPlus.kt](/lesson04/app/src/main/java/com/example/compose_sample/layout/LayoutsPlus.kt)
...
[Modifiers.kt](/lesson04/app/src/main/java/com/example/compose_sample/modifier/Modifiers.kt)
...
[ModifiersSizes.kt](/lesson04/app/src/main/java/com/example/compose_sample/modifier/ModifierSizes.kt)
...
[ModifierAlpha.kt](/lesson04/app/src/main/java/com/example/compose_sample/modifier/ModifierAlpha.kt)

`Modifier.alpha()` позволяет настроить прозрачность компонента

[ModifierBackground.kt](/lesson04/app/src/main/java/com/example/compose_sample/modifier/ModifierBackground.kt)

`Modifier.alpha()` позволяет нарисовать задний фон элемента.

[ModifierClip.kt](/lesson04/app/src/main/java/com/example/compose_sample/modifier/ModifierClip.kt)

`Modifier.clip()` позволяет настроить форму элемента.

[ModifierOrder.kt](/lesson04/app/src/main/java/com/example/compose_sample/modifier/ModifierOrder.kt)
...
[ModifierSemantics.kt](/lesson04/app/src/main/java/com/example/compose_sample/modifier/ModifierSemantics.kt)
...
[Пример с каунтером](/lesson04/app/src/main/java/com/example/compose_sample/recomposition/Counter1.kt)

Для того, чтобы `MutableState` не пересоздался заново при рекомпозиции, он кешируется с помощью вызова функции `remember { ... }`.

### Пропускаемость

[Рассмотрим второй пример](/lesson04/app/src/main/java/com/example/compose_sample/recomposition/Counter2.kt)
...
В Compose также определены внешние типы, которые будут считаться стабильными: `Pair`, `Result`, `Comparator`, `ClosedRange`, коллекции из библиотеки `kotlinx.collessons.immutable`, `dagger.Lazy` и другие.
...
- [Types.kt](/lesson04/app/src/main/java/com/example/compose_sample/stability/Types.kt)

- [Types2.kt](/lesson04/app/src/main/java/com/example/compose_sample/stability/Types2.kt)

- [Types3.kt](/lesson04/app/src/main/java/com/example/compose_sample/stability/Types3.kt)
...
[DefaultParameter.kt](/lesson04/app/src/main/java/com/example/compose_sample/stability/DefaultParameter.kt)
...
[Пример с remember](/lesson04/app/src/main/java/com/example/compose_sample/recomposition/Remember.kt)

[Пример с remember с key](/lesson04/app/src/main/java/com/example/compose_sample/recomposition/RememberWithKey.kt)
...
[Простой пример с CompositionLocal](/lesson04/app/src/main/java/com/example/compose_sample/compositionlocal/CompositionLocal.kt)
...
[Полный пример](/lesson04/app/src/main/java/com/example/compose_sample/compositionlocal/ds)
...
[Пример экрана с MaterialDesign](/lesson04/app/src/main/java/com/example/compose_sample/material/MaterialTheme.kt)
...
[SideEffect.kt](/lesson04/app/src/main/java/com/example/compose_sample/side/SideEffect.kt)
...
[LaunchedEffect.kt](/lesson04/app/src/main/java/com/example/compose_sample/side/LaunchedEffect.kt)
...
[DisposableEffect.kt](/lesson04/app/src/main/java/com/example/compose_sample/side/DisposableEffect.kt)
...
[activity_main.xml](/lesson04/app/src/main/res/layout/activity_main.xml)
...
[MainActivity.kt](/lesson04/app/src/main/java/com/example/compose_sample/MainActivity.kt)

Также мы можем добавить AndroidView в Compose.

[AndroidViewInCompose.kt](/lesson04/app/src/main/java/com/example/compose_sample/composeview/AndroidViewInCompose.kt)
...
[Полный пример](/lesson04/app/src/main/java/com/example/compose_sample/navigation/SimpleNavigation.kt)
...
[Полный пример](/lesson04/app/src/main/java/com/example/compose_sample/navigation/navcompose/NavigationCompose.kt)
